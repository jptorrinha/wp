...
// in javascript/portfolio_inline.js replace
...
$args=array(
  ...
  ?>
      <li class="item <?php echo $slug_list; ?>"> <a href="<?php the_permalink(); ?>" class="view2"><img src="<?php echo $featured_images[0]; ?>" alt="<?php the_title(); ?>" /></a>
        <div class="item-info">
          <h3 class="title">
            <?php the_title(); ?>
          </h3>
